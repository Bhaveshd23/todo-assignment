...
const Home = () => {
    ...
    useEffect(() => {
        fetch("https://todo-servers.herokuapp.com/todo", {
            method: "GET",
            headers: {
    ...
    const handleActivity = (e) => {
        ...
        fetch("https://todo-servers.herokuapp.com/todo/addtodo", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
                Authorization: localStorage.getItem("token"),
                    ...
                    <div className="innercontent">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                {/* <tr>
                                    <td>Running</td>
                                    <td>{completed ? "Completed" : ongoing ? "Ongoing" : "Pending"}</td>
                                    <td>{end ? totalTime : ""}</td>
                                    <td>
                                        {
                                            end === true ? "" :
                                                start === false ? <button onClick={handleStart}>Start</button> :
                                                    <div>
                                                        <button onClick={handleEnd}>End</button>
                                                        {
                                                            pause ? <button onClick={handleResume}>Resume</button> : <button onClick={handlePause}>Pause</button>
                                                        }
                                                    </div>
                                        }
                                    </td>
